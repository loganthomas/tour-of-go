...
func main() {
	v := 42 // v is of type int with value 42
	// v := 1.23  // v is of type float64 with value 1.23
	// v := 0.5 + 0.3i  // v is of type complex128 with value (0.5+0.3i)
	// v := "hi"  // v is of type string with value hi
